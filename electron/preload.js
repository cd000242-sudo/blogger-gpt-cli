...
const api = {
    ...
    adsenseAnalyzeContentValue: (payload) => electron_1.ipcRenderer.invoke('adsense:analyze-content-value', payload),
    adsenseBoostPostValue: (payload) => electron_1.ipcRenderer.invoke('adsense:boost-post-value', payload),
    adsenseBulkCleanupPosts: (payload) => electron_1.ipcRenderer.invoke('adsense:bulk-cleanup-posts', payload),
    adsenseListYearlyPosts: (payload) => electron_1.ipcRenderer.invoke('adsense:list-yearly-posts', payload),
    adsenseRefreshYearlyPost: (payload) => electron_1.ipcRenderer.invoke('adsense:refresh-yearly-post', payload),
    adsenseApprovalReadinessCheck: (payload) => electron_1.ipcRenderer.invoke('adsense:approval-readiness-check', payload),
    adsenseInjectSchemaOrg: (payload) => electron_1.ipcRenderer.invoke('adsense:inject-schema-org', payload),
    adsenseCreateAuthorPage: (payload) => electron_1.ipcRenderer.invoke('adsense:create-author-page', payload),
    adsenseAdvancedPolicyScan: (payload) => electron_1.ipcRenderer.invoke('adsense:advanced-policy-scan', payload),
    // ── 플랫폼 연동 확인 ──
    ...
    loadTistoryCategories: (payload = {}) => electron_1.ipcRenderer.invoke('tistory-load-categories', payload),
